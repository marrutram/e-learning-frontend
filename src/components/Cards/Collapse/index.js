    ...
    render() {
        return (
            <div className="card shadow mb-4">
                ...
                <a href="e-learning-frontend/src/components/Cards/Collapse/index#collapseCardExample" className="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
